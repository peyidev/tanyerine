...
// PREPARE
                ...
                if(images > 1 || !o.smallthumb_hide_single){
                    ...
                    smallthumb_margin = parseInt($smallthumb.css('marginTop'), 7);
                    smallthumb_padding = parseInt($smallthumb.css('paddingLeft'), 10) + parseInt($smallthumb.css('paddingRight'), 10) + parseInt($smallthumb_images.css('marginLeft'), 7) + parseInt($smallthumb_images.css('marginRight'), 7) + parseInt($smallthumb_images.css('paddingLeft'), 10) + parseInt($smallthumb_images.css('paddingRight'), 10);
                    if(smallthumbs_align==='vert'){
...
// FUNCTIONS
                ...
                var st_click = function($next_active, moved){
                    ...
                    if(navigator.userAgent.toLowerCase().indexOf("firefox") != -1) {
                        $container.children('li.etalage_small_thumbs').css('overflow','visible');
                        setTimeout(function(){$container.children('li.etalage_small_thumbs').css('overflow','hidden');},1);
                    }

...
class J2t_Rewardpoints_Block_Dashboard extends Mage_Core_Block_Template
{
    ...
    public function showReferralColumn()
    {
        $store_id = Mage::app()->getStore()->getId();
        return (bool)Mage::getStoreConfig('rewardpoints/registration/show_referral_dashboard', $store_id);
    }


    public function getReferralPointsReceived(){
        $store_id = Mage::app()->getStore()->getId();
        $customerId = Mage::getModel('customer/session')->getCustomerId();
        $reward_model = Mage::getModel('rewardpoints/stats');
        
        return $reward_model->getRealPointsReceivedNoExpiry($customerId, $store_id, true)+0;
    }

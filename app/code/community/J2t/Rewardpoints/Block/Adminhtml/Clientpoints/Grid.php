 ...
 */
class J2t_Rewardpoints_Block_Adminhtml_Clientpoints_Grid extends J2t_Rewardpoints_Block_Adminhtml_Widget_Grid
{
  ...
  protected function _prepareCollection()
  {
    ...
    if ($this->getFromDate()) {
        $collection->getSelect()->where('date_insertion >= ?', $this->getFromDate());
    }
    if ($this->getToDate()) {
        $collection->getSelect()->where('date_insertion < ?', $this->getToDate());
    }
  ...
  protected function _prepareColumns()
  {
      ...
      $this->addColumn('id', array(
          ...
          'type'  => 'number',
          'is_system'   => (bool)$this->getCSVExport(),
      ));
      ...
      $this->addColumn('date_insertion', array(
          'header'    => Mage::helper('rewardpoints')->__('Insertion Date'),
          'align'     => 'right',
          'index'     => 'date_insertion',
          'type'      => 'date',
          'width'     => '50px',
          'filter'    => false,
      ));

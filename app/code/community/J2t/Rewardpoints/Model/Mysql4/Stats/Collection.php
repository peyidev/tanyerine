...
//        $lastname  = $customersCollection->getAttribute('lastname');
    ...
    public function joinOnlyReferral($rewardpoints_referral_id = null)
    {
        $this->getSelect()->where('main_table.rewardpoints_referral_id IS NOT NULL');
        if ($rewardpoints_referral_id){
            $this->getSelect()->where('main_table.rewardpoints_referral_id = ?', $rewardpoints_referral_id);
        }
        return $this;
    }

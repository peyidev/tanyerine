...
class J2t_Rewardpoints_Model_Stats extends Mage_Core_Model_Abstract
{
    ...
    public function getRealPointsReceivedNoExpiry($customer_id, $store_id, $only_referral = false, $rewardpoints_referral_id = null){
        ...
        if ($only_referral){
            $collection->joinOnlyReferral($rewardpoints_referral_id);
        }
